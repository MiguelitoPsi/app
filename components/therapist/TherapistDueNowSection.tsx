...
export const TherapistDueNowSection: React.FC = memo(
  function TherapistDueNowSectionComponent() {
    const { data: allTasks, isLoading } = trpc.therapistTasks.getAll.useQuery(
      undefined,
      {
        staleTime: 2 * 60 * 1000,
      }
