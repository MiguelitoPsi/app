...
export const TherapistProfileCard: React.FC = memo(function TherapistProfileCardComponent() {
  const { stats, isLoading: isLoadingGame } = useTherapistGame()

  const { data: statsData, isLoading: isLoadingStats } = trpc.therapistXp.getStats.useQuery(
    undefined,
    {
      staleTime: 2 * 60 * 1000,
    }
    ...
    <div className='flex h-full flex-col'>
      ...
      <div className='relative overflow-hidden rounded-t-2xl bg-gradient-to-br from-violet-500 to-purple-600 px-6 pb-12 pt-6'>
        ...
        <div className='relative text-center'>
          <p className='text-sm font-medium text-white/80'>Seu guia de bem-estar</p>
        </div>
      </div>
      ...
      <div className='grid grid-cols-2 gap-3 px-6 pt-4'>
        ...
        <div className='rounded-xl bg-amber-50 p-3 dark:bg-amber-900/20'>
          <div className='flex items-center gap-2'>
            ...
            <span className='text-xs text-amber-600 dark:text-amber-400'>Relatórios</span>
          </div>
        ...
        <div className='rounded-xl bg-rose-50 p-3 dark:bg-rose-900/20'>
          <div className='flex items-center gap-2'>
            ...
            <span className='text-xs text-rose-600 dark:text-rose-400'>Streak</span>
          </div>
