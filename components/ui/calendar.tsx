  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_start: 'day-range-start [&>button]:rounded-l-full [&>button]:rounded-r-none',
        range_end: 'day-range-end [&>button]:rounded-r-full [&>button]:rounded-l-none',
        selected: '[&>button]:bg-[#A8BBA3] [&>button]:text-white [&>button]:hover:bg-[#8FA889]',
        today: '[&>button]:font-bold [&>button]:underline',
        outside: '[&>button]:text-slate-300 dark:[&>button]:text-slate-600 [&>button]:opacity-50',
        disabled:
          '[&>button]:text-slate-300 dark:[&>button]:text-slate-600 [&>button]:opacity-30 [&>button]:pointer-events-none',
        range_middle: 'aria-selected:bg-[#A8BBA3]/20 aria-selected:text-[#A8BBA3]',
        hidden: 'invisible',
        ...classNames,
      }}
      components={{
