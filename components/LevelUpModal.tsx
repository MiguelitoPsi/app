    ...
    >
      ...
      >
        <div className="relative overflow-hidden rounded-2xl bg-slate-900 border border-yellow-500/30 shadow-2xl shadow-yellow-500/20 p-8 text-center">
          ...
          <div className="absolute -top-24 -left-24 w-48 h-48 bg-yellow-500/20 rounded-full blur-3xl animate-pulse" />
          ...
          {/* Text */}
          <h2 className="text-3xl font-bold text-white mb-2 animate-scale-up">
            Level Up!
          </h2>
          ...
          {/* Button */}
          <button
            className="w-full py-3 px-6 bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-400 hover:to-yellow-500 text-white font-bold rounded-xl shadow-lg shadow-yellow-500/25 transform transition-all hover:scale-105 active:scale-95"
            onClick={handleClose}
            type="button"
          >
            Continuar Jornada
