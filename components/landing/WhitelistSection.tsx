  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-xl px-6 sm:px-8">
        ...
        >
          Psicólogos selecionados terão acesso a conteúdo exclusivo + preço
          promocional. Sem cartão. Sem compromisso.
        </motion.p>
        ...
        {state === "success" ? (
          ...
          >
            ...
            <p className="mt-2 text-sm text-slate-500">
              ...
              antecipado. Fique de olho na caixa de entrada.
            </p>
          </motion.div>
        ) : (
          <motion.form
          ...
          >
            ...
            <p className="text-center text-xs text-slate-400">
              Seus dados estão protegidos pela LGPD. Nenhum spam. Só acesso
              antecipado.
            </p>
          </motion.form>
        )}
