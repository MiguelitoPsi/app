  ...
  return (
    <section className='relative overflow-hidden bg-white py-24 sm:py-32 lg:py-40' ref={ref}>
      <div className='mx-auto max-w-5xl px-6 sm:px-8'>
        ...
        >
          Um app que transforma o acompanhamento terapêutico em uma jornada de progresso visível — e
          viciante no bom sentido.
        </motion.p>
            ...
            >
              ...
              <div
                className={`overflow-hidden transition-all duration-400 ease-[cubic-bezier(0.22,1,0.36,1)] ${
                  expanded === feature.id ? 'max-h-40 pb-6 opacity-100' : 'max-h-0 opacity-0'
                }`}
              >
        ...
        >
          <div className='flex items-baseline gap-3'>
            <span className='font-black text-5xl tracking-tight text-slate-900 sm:text-6xl'>9</span>
            <span className='text-lg font-medium text-slate-500 sm:text-xl'>
              categorias de conquistas
            </span>
          </div>
          <p className='text-sm text-slate-400'>
            Evolução, tarefas, meditação, diário, humor, streaks, recompensas e mais
          </p>
        </motion.div>
      </div>
    </section>
