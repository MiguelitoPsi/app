...
export function MethodologySection() {
  ...
  return (
    <section className='relative overflow-hidden bg-white py-24 sm:py-32 lg:py-40' ref={ref}>
          ...
          <div className='relative rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-8 sm:p-12'>
            ...
            <div className='relative space-y-6 text-base leading-relaxed text-slate-600 sm:text-lg'>
              <p>
                ...
                <strong className='text-slate-900'>pontos fortes</strong>, recursos e crenças
                adaptativas do paciente, não apenas nos sintomas.
              </p>
              <p>
                Quando seu paciente escreve no diário, a IA não dá conselhos genéricos. Ela{' '}
                <strong className='text-slate-900'>valida o sentimento, identifica forças</strong>{' '}
                que o paciente demonstrou e oferece uma perspectiva alternativa construtiva —
                exatamente como você faria.
              </p>
              <p>
                O Diagrama de Conceituação Cognitiva de Beck é preenchido automaticamente a partir
                das sessões, diários e registros de humor — economizando{' '}
                <strong className='text-slate-900'>sessões inteiras de avaliação</strong>. Você
                revisa, ajusta e aplica.
              </p>
            </div>
