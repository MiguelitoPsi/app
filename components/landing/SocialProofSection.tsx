...
export function SocialProofSection() {
  ...
  return (
    <section className='relative overflow-hidden bg-slate-950 py-20 sm:py-28' ref={ref}>
      <div className='mx-auto max-w-5xl px-6 sm:px-8'>
        ...
        <div className='mt-14 flex flex-wrap justify-center gap-x-12 gap-y-10 sm:mt-16 sm:gap-x-16 lg:gap-x-24'>
          {STATS.map((stat, i) => (
            ...
            >
              ...
              <p className='mt-2 max-w-[160px] text-sm text-slate-400 sm:text-base'>{stat.label}</p>
            </motion.div>
          ))}
        </div>
        ...
        >
          <div className='flex items-center gap-2 text-slate-500'>
            ...
            <span className='text-xs font-medium sm:text-sm'>Dados criptografados</span>
          </div>
          <div className='flex items-center gap-2 text-slate-500'>
            <svg
              className='h-5 w-5'
            ...
            <span className='text-xs font-medium sm:text-sm'>LGPD compliant</span>
          </div>
          <div className='flex items-center gap-2 text-slate-500'>
            <svg
              className='h-5 w-5'
            ...
            <span className='text-xs font-medium sm:text-sm'>Servidores no Brasil</span>
          </div>
        </motion.div>
      </div>
    </section>
