...
export function PainSection() {
  ...
  return (
    <section className='relative overflow-hidden bg-slate-950 py-24 sm:py-32 lg:py-40' ref={ref}>
      ...
      <div className='mx-auto max-w-4xl px-6 sm:px-8'>
            ...
            >
              <div className='flex items-start gap-4 sm:gap-6'>
                ...
                <p className='text-base leading-relaxed text-slate-400 sm:text-lg md:text-xl'>
                  <span className='font-semibold text-white'>{pain.highlight}</span>
        ...
        >
          E se tudo isso <span className='font-bold text-[#a1c797]'>simplesmente acontecesse</span>{' '}
