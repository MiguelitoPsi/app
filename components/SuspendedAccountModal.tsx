  ...
  return (
    <div className='fixed inset-0 z-[100] flex items-center justify-center bg-black/70 backdrop-blur-sm'>
      <div className='mx-4 w-full max-w-md rounded-xl border border-red-500/50 bg-slate-900 p-6 shadow-2xl'>
        ...
        <h2 className='mb-2 text-center text-xl font-semibold text-white'>Conta Suspensa</h2>
        ...
        {suspensionData.bannedAt && (
          <div className='mb-4 rounded-lg bg-slate-800/50 p-4'>
            <p className='text-sm text-slate-400'>
              <span className='font-medium text-slate-300'>Data da suspensão:</span>{' '}
        ...
        <div className='rounded-lg bg-amber-500/10 p-4 mb-6'>
          <p className='text-sm text-amber-300'>
            <span className='font-medium'>Precisa de ajuda?</span> Entre em contato com o suporte
            para mais informações sobre a suspensão da sua conta.
          </p>
        </div>
