        ...
        <div className="max-h-[60vh] overflow-y-auto p-6 sm:p-8">
          <div className="prose prose-slate max-w-none dark:prose-invert prose-headings:text-slate-900 dark:prose-headings:text-white prose-p:text-slate-800 dark:prose-p:text-slate-200 prose-li:text-slate-800 dark:prose-li:text-slate-200 prose-strong:text-slate-900 dark:prose-strong:text-white">
            <p className="text-slate-800 dark:text-slate-200 font-medium">
              Este Termo de Consentimento Livre e Esclarecido (TCLE) tem como
              objetivo fornecer informações sobre a utilização da plataforma de
            ...
            <p className="text-slate-800 dark:text-slate-200">
              Esta plataforma foi desenvolvida para auxiliar no acompanhamento
              do seu processo terapêutico, permitindo o registro de humor,
              diário de pensamentos, realização de tarefas e meditações.
            </p>
            ...
            <p className="text-slate-800 dark:text-slate-200">
              Todas as informações registradas na plataforma são confidenciais e
              protegidas. Apenas você e seu terapeuta vinculado terão acesso aos
              dados inseridos.
            </p>
            ...
            <p className="text-slate-800 dark:text-slate-200">
              ...
              anonimizados poderão ser utilizados para fins estatísticos e de
              pesquisa.
            </p>
            ...
            <p className="text-slate-800 dark:text-slate-200">
              Você pode deixar de utilizar a plataforma a qualquer momento, sem
              prejuízo ao seu atendimento terapêutico presencial ou online.
            </p>
        ...
        <div className="border-slate-100 border-t bg-slate-50 p-6 dark:border-slate-800 dark:bg-slate-900/50">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-end">
            <p className="text-center text-slate-500 text-xs sm:text-left dark:text-slate-400">
              Ao clicar em "Li e Concordo", você aceita os termos descritos
              acima.
            </p>
            <button
