          ...
          <div className='flex items-center justify-between'>
            <div className='flex items-center gap-2 sm:gap-3'>
              ...
              <div className='min-w-0'>
                ...
                <p className='text-xs text-white/80 sm:text-sm lg:text-base'>Relatórios</p>
              </div>
            </div>
            <button
                    ...
                    <div className='rounded-2xl bg-white p-6 shadow-sm dark:bg-slate-900'>
                      <div className='flex flex-col items-center justify-center py-8 text-center'>
                        ...
                        {cognitiveData ? (
                          ...
                          <>
                            <p className='mb-4 max-w-sm text-slate-500 text-sm'>
                              Primeiro, preencha a conceituação cognitiva do paciente para poder
                              gerar um plano terapêutico.
                            </p>
                            <button
