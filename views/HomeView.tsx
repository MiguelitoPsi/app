...
export const HomeView: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="flex h-full flex-col overflow-hidden bg-[#F7F1DE] dark:bg-slate-950">
        ...
        {/* Header Section */}
        <div className="flex justify-end gap-2 px-4 pt-1 shrink-0">
        ...
        <main
          className="flex-1 flex flex-col gap-5 overflow-y-auto overscroll-contain scroll-smooth px-4 py-3 pb-6"
          id="main-content"
        ...
        >
          <div className="flex flex-col gap-2.5">
            ...
            {unviewedFeedbackCount > 0 && (
              <button
                ...
                className="slide-in-from-top-4 flex w-full animate-in items-center justify-between rounded-2xl border border-emerald-100 bg-emerald-50 p-3 shadow-sm active:scale-[0.98] dark:border-emerald-900/30 dark:bg-emerald-900/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2"
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <p className="font-medium text-emerald-600/80 text-[10px] sm:text-xs dark:text-emerald-400/80">
                      Você tem {unviewedFeedbackCount} novo(s) feedback(s) do
                      seu terapeuta.
                    </p>
                  </div>
                </div>
            ...
            {urgentTasks.length > 0 && (
              <button
                ...
                className="slide-in-from-top-4 flex w-full animate-in items-center justify-between rounded-2xl border border-red-100 bg-red-50 p-3 shadow-sm active:scale-[0.98] dark:border-red-900/30 dark:bg-red-900/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2"
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <p className="font-medium text-red-600/80 text-[10px] sm:text-xs dark:text-red-400/80">
                      ...
                      {urgentTasks.length > 1 ? "s" : ""} de alta prioridade
                      hoje.
                    </p>
                  </div>
                </div>
            ...
            {selectedMood === "anxious" && (
              <button
                ...
                className="slide-in-from-top-4 flex w-full animate-in items-center justify-between rounded-2xl border border-teal-100 bg-teal-50 p-3 shadow-sm active:scale-[0.98] dark:border-teal-900/30 dark:bg-teal-900/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2"
          ...
          <div className="flex flex-col items-center gap-1">
            <p className="text-center font-medium text-slate-500 text-sm dark:text-slate-400">
              {stats.name ? `Olá, ${stats.name.split(" ")[0]}` : "Olá"} 👋
            </p>
            <h2 className="text-center font-bold text-slate-800 text-lg dark:text-white">
              Como está seu dia?
            </h2>
            <div className="mt-2">
          ...
          <div className="flex flex-col gap-4">
            {/* Quick Mood Check-in */}
            {/*     <fieldset className="rounded-2xl border border-slate-100  text-white bg-[#C4A484]/30 p-4 shadow-sm transition-colors dark:border-slate-800 dark:bg-slate-900">
              ...
              <div className="mb-3 flex items-center justify-between">
                ...
                {isXPAvailable && (
                  <span className="animate-pulse rounded-full bg-sky-100 px-2.5 py-1 font-bold text-[10px] text-sky-600 dark:bg-sky-900/30 dark:text-sky-300">
                    +{XP_REWARDS.mood} XP
              ...
              <div className="grid grid-cols-6 gap-1">
                {moods.map((m) => (
                  <button
                    ...
                    className={`flex flex-col items-center gap-1.5 rounded-2xl py-2.5 px-1 transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:ring-offset-2 ${
                      selectedMood === m.id
                        ? "scale-105 bg-sky-50 shadow-md ring-2 ring-sky-200 dark:bg-sky-900/30 dark:ring-sky-700"
                        : "active:scale-95 hover:bg-slate-50 dark:hover:bg-slate-800/60"
            ...
            >
              <button
                ...
                className="group relative overflow-hidden rounded-2xl p-4 shadow-md transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-400 focus-visible:ring-offset-2"
                onClick={() => {
                  playNavigation();
                  router.push("/journal");
                }}
                type="button"
              >
                <div className="absolute inset-0 bg-[#B87C4C] from-sky-400 via-sky-500 to-blue-600" />
                <div className="absolute inset-0 opacity-[0.07] bg-[radial-gradient(circle_at_30%_20%,white_0%,transparent_50%)]" />
                <div className="relative flex flex-col items-start gap-3 text-white">
                  ...
                  <div>
                    ...
                    <div
                      aria-hidden="true"
                      className="mt-2 inline-block rounded-full bg-white/20 px-2.5 py-0.5 font-bold text-[10px] sm:text-xs"
                    >
              ...
              <button
                ...
                className="group relative overflow-hidden rounded-2xl p-4 shadow-md transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-400 focus-visible:ring-offset-2"
                onClick={() => {
                  playNavigation();
                ...
                type="button"
              >
                <div className="absolute inset-0 bg-[#A8BBA3] from-teal-400 via-emerald-500 to-teal-600" />
                <div className="absolute inset-0 opacity-[0.07] bg-[radial-gradient(circle_at_30%_20%,white_0%,transparent_50%)]" />
                <div className="relative flex flex-col items-start gap-3 text-white">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/20 backdrop-blur-sm">
                    <Heart size={20} />
          ...
          {/*  <section
            ...
            className="rounded-2xl border border-slate-100 bg-white p-4 shadow-sm transition-colors dark:border-slate-800 dark:bg-slate-900"
          >
            <div className="mb-3 flex items-center gap-2">
              <div
                aria-hidden="true"
                className="flex h-8 w-8 items-center justify-center rounded-xl bg-sky-50 text-sky-600 dark:bg-sky-900/20 dark:text-sky-400"
              >
                <BarChart2 size={16} />
              </div>
              ...
              <div className="p-6 sm:p-8">
                <div className="mb-6 rounded-xl bg-amber-50 border border-amber-200 p-4 dark:bg-amber-900/20 dark:border-amber-800">
                  <p className="text-amber-800 text-sm dark:text-amber-300">
                    <strong>Atenção:</strong> Ao excluir sua conta, todos os
                    seus dados serão marcados para remoção. Conforme nossa
                    política de privacidade, seus dados serão
              ...
              <div className="max-h-[60vh] overflow-y-auto p-6 sm:p-8">
                <div className="prose prose-slate max-w-none dark:prose-invert prose-headings:text-slate-900 dark:prose-headings:text-white prose-p:text-slate-800 dark:prose-p:text-slate-200 prose-li:text-slate-800 dark:prose-li:text-slate-200 prose-strong:text-slate-900 dark:prose-strong:text-white">
                  <p className="text-slate-800 dark:text-slate-200 font-medium">
                    Este Termo de Consentimento Livre e Esclarecido (TCLE) tem
                    como objetivo fornecer informações sobre a utilização da
                  ...
                  <p className="text-slate-800 dark:text-slate-200">
                    Esta plataforma foi desenvolvida para auxiliar no
                    acompanhamento do seu processo terapêutico, permitindo o
                    registro de humor, diário de pensamentos, realização de
                  ...
                  <p className="text-slate-800 dark:text-slate-200">
                    Todas as informações registradas na plataforma são
                    confidenciais e protegidas. Apenas você e seu terapeuta
                    vinculado terão acesso aos dados inseridos.
                  </p>
                  <h3 className="text-slate-900 dark:text-white font-bold">
                    3. Uso de Dados
                  </h3>
                  <p className="text-slate-800 dark:text-slate-200">
                    ...
                    terapêuticos e de melhoria do seu acompanhamento. Dados
                    anonimizados poderão ser utilizados para fins estatísticos e
                    de pesquisa.
                  </p>
                  <h3 className="text-slate-900 dark:text-white font-bold">
                  ...
                  <p className="text-slate-800 dark:text-slate-200">
                    Ao utilizar a plataforma, você se compromete a fornecer
                    informações verídicas e a utilizar os recursos de forma
                    responsável.
                  </p>
                  <h3 className="text-slate-900 dark:text-white font-bold">
                    5. Desistência
                  ...
                  <p className="text-slate-800 dark:text-slate-200">
                    Você pode deixar de utilizar a plataforma a qualquer
                    momento, sem prejuízo ao seu atendimento terapêutico
