...
import type { RemixIconType } from '@/lib/utils/icon-map'
...
export const JournalView: React.FC<JournalViewProps> = ({ goHomeAction, goHome }) => {
  ...
  const moods: { id: Mood; icon: RemixIconType; label: string }[] = [
    ...
    { id: 'fearful', icon: RiEyeOffLine, label: translateMood('fearful') },
            ...
            >
              ...
              <div className='space-y-2 pt-2 sm:space-y-3 sm:pt-4'>
                ...
                >
                  {isAnalyzing ? (
                    <>
                      <RiSparklingLine aria-hidden='true' className='animate-spin' size={18} />
