    ...
    <>
      ...
      <div className="flex h-full flex-col bg-slate-50 dark:bg-slate-950">
        ...
        <div aria-atomic="true" aria-live="polite" className="sr-only">
          {isAnalyzing &&
            "Analisando seu pensamento com inteligência artificial..."}
          {step === 2 &&
            aiResult &&
            "Análise concluída. Insight terapêutico disponível."}
        </div>
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="sr-only" id={`${thoughtId}-hint`}>
                  Descreva o pensamento que está tendo. Quanto mais detalhes,
              ...
              <fieldset className="space-y-2 sm:space-y-3">
                ...
                <div className="grid grid-cols-6 gap-2 sm:gap-3">
                  {moods.map((m) => {
                    const isSelected =
                      emotion === m.id && !customEmotion.trim();
                    return (
                      <button
                      ...
                      >
                        ...
                        >
                          <m.icon className="w-6 h-6 sm:w-6 sm:h-6" />
                        </span>
              ...
              <div className="space-y-2 pt-2 sm:space-y-3 sm:pt-4">
                ...
                <p className="sr-only" id="analyze-hint">
                  A inteligência artificial irá analisar seu pensamento e
                  fornecer insights terapêuticos.
                </p>
                ...
                <button
                  ...
                  disabled={
                    !(thought.trim() && emotion && intensity) ||
                    isSaving ||
                    isAnalyzing
                  }
