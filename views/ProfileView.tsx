          ...
          <div className="slide-in-from-right-4 fade-in animate-in duration-300">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              {allBadges.map((badge, index) => {
                const { isUnlocked, progressPercentage, currentProgress } =
          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between rounded-xl border border-slate-100 bg-slate-50 p-4 transition-colors dark:border-slate-700 dark:bg-slate-800">
                ...
                <button
                  className={`relative h-6 w-12 rounded-full transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900 ${
