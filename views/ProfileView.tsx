                        ...
                        return (
                          ...
                          >
                            ...
                            <div className='z-10 min-w-0 flex-1'>
                              <div
                                className={`truncate font-bold text-xs sm:text-sm ${isUnlocked ? 'text-slate-800 dark:text-white' : 'text-slate-500 dark:text-slate-400'}`}
                              >
                                {badge.name}
                              </div>
          ...
          >
            ...
            <div className='space-y-3 sm:space-y-4'>
              <div className='flex items-center justify-between rounded-xl border border-slate-100 bg-slate-50 p-3 transition-colors sm:p-4 dark:border-slate-700 dark:bg-slate-800'>
                ...
                <button
                  className={`touch-target relative h-6 w-12 rounded-full transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900 ${stats.theme === 'dark' ? 'bg-violet-600' : 'bg-slate-300'}`}
                  onClick={toggleTheme}
                  type='button'
                >
                  <span
              ...
              {onNavigate && (stats.role === 'psychologist' || stats.role === 'admin') && (
                <button
