        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <div className="flex flex-col gap-6">
            ...
            <ProfileCard
              ...
              icon={<RiUserLine className="h-5 w-5 text-sky-500" />}
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <InfoRow
                  hasBorder={true}
                  icon={<RiPhoneLine className="h-4 w-4 text-slate-400" />}
                  label="Telefone"
                  value={therapistData.phone}
                />
                <InfoRow
                  hasBorder={false}
                  icon={<RiUserLine className="h-4 w-4 text-slate-400" />}
                  label="Nascimento"
            ...
            {/* Card: Conta */}
            <ProfileCard
              icon={<RiShieldLine className="h-5 w-5 text-sky-500" />}
              title="Conta"
            >
              <div className="flex flex-col">
                <InfoRow
                  hasBorder={true}
                  icon={<RiMailLine className="h-4 w-4 text-slate-400" />}
                  label="E-mail"
          ...
          <div className="lg:col-span-2">
            <ProfileCard
              ...
              icon={<RiBuildingLine className="h-5 w-5 text-sky-500" />}
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div className="col-span-2 border-b border-slate-100 pb-4 dark:border-slate-700">
                  ...
                  <p className="flex flex-row items-center gap-2 text-lg font-medium text-slate-900 dark:text-white">
                    <RiBuildingLine className="h-5 w-5 text-sky-500" />
                ...
                <div className="border-b border-slate-100 pb-4 dark:border-slate-700">
                  ...
                  <p className="flex flex-row items-center gap-2 text-slate-900 dark:text-white">
                    <RiMapLine className="h-4 w-4 text-slate-400" />
