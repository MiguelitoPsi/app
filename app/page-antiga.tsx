      ...
      <section className='relative overflow-hidden px-4 pt-32 pb-20'>
        ...
        <div className='relative mx-auto max-w-5xl text-center'>
          ...
          <p className='mx-auto mb-10 max-w-2xl text-lg text-slate-400 sm:text-xl leading-relaxed'>
            ...
            para auxiliar no monitoramento de humor, registro de pensamentos e adesão a hábitos
            saudáveis.
          </p>
        ...
        <div className='mx-auto max-w-6xl'>
          <div className='mb-16 text-center max-w-3xl mx-auto'>
            ...
            <p className='text-slate-400 text-lg'>
              Ferramentas baseadas em evidências científicas, adaptadas para uma experiência digital
              envolvente e segura.
            </p>
          </div>
        ...
        <div className='mx-auto max-w-6xl relative'>
          <div className='grid md:grid-cols-2 gap-12 items-center'>
            <div>
              ...
              <p className='text-slate-400 text-lg mb-8 leading-relaxed'>
                O Nepsis funciona como uma extensão do consultório, permitindo que você acompanhe a
                evolução do paciente entre as sessões.
              </p>
          ...
          <div className='flex flex-col md:flex-row justify-between items-center gap-6'>
            ...
            <div className='flex flex-col items-center md:items-end gap-3'>
              <div className='flex items-center gap-4 text-sm'>
                <Link className='text-slate-400 hover:text-white transition-colors' href='/privacy'>
                  Política de Privacidade
                </Link>
                <span className='text-slate-700'>|</span>
                <Link className='text-slate-400 hover:text-white transition-colors' href='/terms'>
                  Termos de Uso
                </Link>
              </div>
              ...
              <div className='text-slate-500 text-sm text-center md:text-right'>
                ...
                <p className='mt-1 text-xs'>
                  Atenção: Em caso de crise ou emergência, ligue para o CVV (188) ou procure o
      ...
      >
        ...
        <div className='absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20'>
          ...
          <div className='absolute -bottom-10 sm:-bottom-12 left-1/2 -translate-x-1/2 text-center w-32 sm:w-40'>
            <span className='text-sm sm:text-lg font-bold text-white block'>Nepsis AI</span>
            <span className='text-[10px] sm:text-xs text-sky-400'>Processamento Seguro</span>
          </div>
        </div>
