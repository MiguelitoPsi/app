...
export function SettingsProfileForm({ activeTab }: SettingsProfileFormProps) {
  ...
  const handleSubmit = async () => {
    ...
    if (!validBirthDate) {
      setErrors({
        submit: 'Erro nos dados do perfil (Data). Verifique a aba Perfil.',
      })
      setIsSubmitting(false)
      return
    }
          ...
          <div className='flex-1 grid grid-cols-12 gap-3'>
            ...
            <div className='col-span-12'>
              ...
              <input
                ...
                } bg-white px-3 py-2 text-sm text-slate-800 placeholder-slate-400 transition-colors focus:border-sky-400 focus:outline-none focus:ring-2 focus:ring-sky-400/20 dark:bg-slate-800 dark:text-slate-200`}
            ...
            <div className='col-span-12'>
              ...
              <textarea
                className={`w-full rounded-lg border ${
                  errors.bio
                    ? 'border-red-300 dark:border-red-700'
                    : 'border-slate-200 dark:border-slate-700'
                } bg-white px-3 py-2 text-sm text-slate-800 placeholder-slate-400 transition-colors focus:border-sky-400 focus:outline-none focus:ring-2 focus:ring-sky-400/20 dark:bg-slate-800 dark:text-slate-200 resize-none`}
                maxLength={500}
              ...
              <div className='flex items-center justify-between'>
                ...
                <p className='ml-auto text-[10px] text-slate-400'>{formData.bio.length}/500</p>
              </div>
            </div>
          </div>
        </div>
