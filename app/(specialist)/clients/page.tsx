...
export default function ClientsPage() {
  ...
  const filteredTherapists = (allTherapists as Therapist[] | undefined)?.filter(
    (therapist: Therapist) =>
      therapist.fullName
        ?.toLowerCase()
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-slate-800 dark:text-white">
                  {patientsData?.filter(
                    (p: any) =>
                      (p as { sessionCount: number }).sessionCount > 0,
                  ).length || 0}
                </p>
              </div>
            </div>
        ...
        {isLoading ? (
                      ...
                      >
                        <div className="p-1.5">
                          <button
                            ...
                            type="button"
                          >
                            <RiLogoutBoxRLine className="h-4 w-4 text-red-500" />
                          ...
                          <button
                            ...
                            type="button"
                          >
                            <RiUserAddLine className="h-4 w-4 text-sky-500" />
                            Encaminhamento
                          </button>
                          <button
                            className="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-left text-sm text-slate-700 transition-colors hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-700"
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800">
              <RiUserLine className="h-8 w-8 text-slate-400" />
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="mx-4 w-full max-w-sm rounded-2xl bg-white p-6 shadow-2xl dark:bg-slate-800">
            ...
            <p className="mb-4 text-xs text-slate-400 dark:text-slate-500">
              Ao desvincular ou dar alta, a conta do paciente será suspensa até
              que ele se vincule a um novo terapeuta.
            </p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="mx-4 w-full max-w-2xl rounded-3xl bg-white p-6 shadow-2xl dark:bg-slate-800 sm:p-8">
            <div className="mb-6 border-b border-slate-100 pb-4 dark:border-slate-700">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400">
                Selecione um novo terapeuta para encaminhar{" "}
                ...
                <div className="divide-y divide-slate-100 dark:divide-slate-700">
                  {filteredTherapists.map((therapist: Therapist) => (
                    ...
                    >
                      ...
                      {selectedNewTherapistId === therapist.id && (
                        <RiCheckDoubleLine className="h-5 w-5 text-sky-500" />
                      )}
                    </button>
                  ))}
                </div>
            ...
            <div className="flex gap-3 border-t border-slate-100 pt-6 dark:border-slate-700">
              ...
              <button
                ...
                disabled={
                  !selectedNewTherapistId || transferPatientMutation.isPending
                }
                onClick={() => {
