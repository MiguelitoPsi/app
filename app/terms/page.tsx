        ...
        <div className="prose prose-invert prose-slate max-w-none prose-headings:text-white prose-p:text-slate-300 prose-li:text-slate-300 prose-strong:text-white">
          ...
          <section className="mb-10 rounded-2xl border border-slate-800 bg-slate-900/50 p-6">
            <p className="text-slate-300 mt-0">
              Bem-vindo ao <strong>Nepsis</strong>. Estes Termos de Uso
              estabelecem as condições para utilização do aplicativo Nepsis
              ("Aplicativo" ou "Serviço") por pacientes e profissionais de
              psicologia. Ao criar uma conta ou utilizar o Aplicativo, você
          ...
          <section className="mb-10">
            ...
            <ul>
              <li>
                <strong>Nepsis</strong>: Aplicativo de saúde mental gamificada
                para acompanhamento terapêutico.
              </li>
              <li>
                <strong>Usuário</strong>: Qualquer pessoa que crie uma conta no
                Aplicativo.
              </li>
              <li>
                <strong>Paciente</strong>: Usuário que utiliza o Aplicativo para
                registro de atividades terapêuticas.
              </li>
              <li>
                <strong>Terapeuta</strong>: Profissional de psicologia inscrito
                em Conselho Regional de Psicologia (CRP).
              </li>
              <li>
                <strong>Vinculação</strong>: Processo pelo qual um paciente
                associa sua conta a um terapeuta.
              </li>
            </ul>
          </section>
          ...
          <section className="mb-10">
            ...
            <ul>
              ...
              <li>
                Tem capacidade legal para aceitar estes termos (ou está sob
                supervisão de responsável legal);
              </li>
              <li>
                Reconhece que o uso continuado do Aplicativo implica aceitação
                de eventuais atualizações destes Termos.
              </li>
            </ul>
          </section>
          ...
          <section className="mb-10">
            ...
            <ul>
              ...
              <li>
                Visualização de registros clínicos (humor, diário, tarefas)
              </li>
          ...
          <section className="mb-10 rounded-2xl border border-red-800/50 bg-red-900/20 p-6">
            <h2 className="text-xl font-bold text-red-300 mt-0">
            ...
            <ul className="text-red-200">
              <li>
                Um substituto para terapia psicológica, psiquiátrica ou qualquer
            ...
            <div className="mt-4 rounded-xl bg-red-900/30 p-4">
              <p className="text-red-200 font-semibold mb-2">
                Em caso de crise ou emergência:
              </p>
          ...
          <section className="mb-10">
            ...
            <ul>
              <li>
                Ter no mínimo 18 anos (ou autorização de responsável legal)
              </li>
            ...
            <p>
              O acesso completo às funcionalidades do Aplicativo para pacientes
              requer vinculação a um terapeuta cadastrado no Nepsis. Sem
              vinculação, o acesso pode ser limitado.
            </p>
            ...
            <ul>
              <li>
                Possuir registro ativo em Conselho Regional de Psicologia (CRP)
              </li>
          ...
          <section className="mb-10">
            ...
            <ul>
              ...
              <li>
                Não utilizar o Aplicativo para fins ilícitos ou prejudiciais
              </li>
          ...
          <section className="mb-10 rounded-2xl border border-amber-800/50 bg-amber-900/20 p-6">
            ...
            <p className="mt-4">
              <strong>IMPORTANTE:</strong> Os conteúdos gerados por IA são
              auxiliares e não substituem a avaliação profissional. Terapeutas
              são integralmente responsáveis por revisar, validar e aprovar
              qualquer informação gerada pela IA antes de utilizar em
          ...
          <section className="mb-10">
            ...
            <p>
              Todo o conteúdo do Aplicativo (código, design, marca, textos,
              funcionalidades) é de propriedade exclusiva do Nepsis ou de seus
              licenciadores e está protegido por leis de propriedade
              intelectual.
            </p>
            <p>
              O usuário mantém a propriedade sobre os conteúdos que criar
              (diários, registros), concedendo ao Nepsis uma licença limitada
              para armazenamento, processamento e exibição conforme necessário
          ...
          <section className="mb-10">
            ...
            <ul>
              ...
              <li>
                Você pode exercer seus direitos (acesso, correção, exclusão,
                portabilidade) a qualquer momento
              </li>
              <li>
                Dados compartilhados com terapeutas exigem vinculação e
                consentimento
              </li>
            </ul>
          </section>
          ...
          <section className="mb-10">
            ...
            <p>
              Novos usuários têm direito a 30 dias de acesso gratuito a todas as
              funcionalidades do Aplicativo.
            </p>

            <h3 className="text-lg font-semibold">10.2. Assinatura</h3>
            <p>
              Após o período de teste, o acesso ao Aplicativo requer assinatura
              paga. Os valores e condições serão informados no momento da
              contratação.
            </p>

            <h3 className="text-lg font-semibold">10.3. Cancelamento</h3>
            <p>
              O cancelamento da assinatura pode ser realizado a qualquer
              momento. O acesso permanece ativo até o fim do período já pago,
          ...
          <section className="mb-10">
            ...
            <ul>
              <li>
                Decisões tomadas com base nas informações registradas ou geradas
                pelo Aplicativo
              </li>
              <li>Resultados terapêuticos obtidos ou não obtidos</li>
              <li>Condutas de terapeutas cadastrados na plataforma</li>
              <li>
                Indisponibilidade temporária do serviço por motivos técnicos
              </li>
          ...
          <section className="mb-10">
            ...
            <p>
              ...
              configurações do perfil ou entrando em contato com o suporte. Seus
              dados serão tratados conforme a Política de Privacidade.
            </p>

            <h3 className="text-lg font-semibold">12.2. Pelo Nepsis</h3>
            <p>
              Reservamo-nos o direito de suspender ou encerrar contas em caso
              de:
            </p>
            <ul>
          ...
          <section className="mb-10">
            ...
            <p>
              ...
              Aplicativo com antecedência mínima de 30 dias. O uso continuado
          ...
          <section className="mb-10 rounded-2xl border border-slate-800 bg-slate-900/50 p-6">
            ...
            <ul>
              <li>
                <strong>E-mail geral</strong>: contato@nepsis.app
              </li>
              <li>
                <strong>Privacidade e dados</strong>: privacidade@nepsis.app
              </li>
            </ul>
          </section>
        </div>
