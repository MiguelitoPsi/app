      ...
      <main className='mx-auto max-w-4xl px-4 pt-24 pb-16'>
        ...
        <div className='prose prose-invert prose-slate max-w-none prose-headings:text-white prose-p:text-slate-300 prose-li:text-slate-300 prose-strong:text-white'>
          ...
          <section className='mb-10'>
            ...
            <p>
              O Nepsis coleta os seguintes dados pessoais, de acordo com a finalidade de cada
              funcionalidade:
            </p>
            ...
            <h3 className='text-lg font-semibold'>2.2. Dados de Uso do Aplicativo (Pacientes)</h3>
            <ul>
            ...
            <h3 className='text-lg font-semibold'>2.3. Dados Profissionais (Terapeutas)</h3>
            <ul>
              <li>Número de registro no CRP (Conselho Regional de Psicologia)</li>
              ...
              <table className='w-full text-sm'>
                <thead>
                  <tr className='border-b border-slate-700'>
                    ...
                    <th className='text-left py-3 px-4 text-white'>Base Legal (LGPD)</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className='border-b border-slate-800'>
                    <td className='py-3 px-4'>Criar e gerenciar conta de usuário</td>
                    <td className='py-3 px-4'>Execução de contrato (Art. 7º, V)</td>
                  </tr>
                  <tr className='border-b border-slate-800'>
                    <td className='py-3 px-4'>
                      Disponibilizar funcionalidades do app (registro de humor, diário, tarefas)
                    </td>
                    <td className='py-3 px-4'>Execução de contrato (Art. 7º, V)</td>
                  </tr>
                  <tr className='border-b border-slate-800'>
                  ...
                  <tr className='border-b border-slate-800'>
                    <td className='py-3 px-4'>Envio de notificações (lembretes, alertas)</td>
                    <td className='py-3 px-4'>Consentimento (Art. 7º, I)</td>
                  </tr>
                  <tr className='border-b border-slate-800'>
                    <td className='py-3 px-4'>Melhoria dos serviços (dados anonimizados)</td>
                    <td className='py-3 px-4'>Legítimo interesse (Art. 7º, IX)</td>
                  </tr>
                  <tr className='border-b border-slate-800'>
                    <td className='py-3 px-4'>Cumprimento de obrigações legais</td>
          ...
          <section className='mb-10 rounded-2xl border border-amber-800/50 bg-amber-900/20 p-6'>
            ...
            <p>
              O Nepsis pode tratar dados pessoais sensíveis relacionados à saúde mental dos
              usuários, como registros de humor, pensamentos e sentimentos. Esses dados são tratados
              exclusivamente com base no{' '}
              <strong>consentimento específico e destacado do titular</strong> (Art. 11, I da LGPD),
              conforme aceito no Termo de Consentimento apresentado no primeiro acesso ao
              aplicativo.
            </p>
            <p>
              Os dados sensíveis são utilizados apenas para fins de acompanhamento terapêutico e
              nunca para finalidades comerciais, publicitárias ou de perfilamento.
            </p>
          </section>
          ...
          <section className='mb-10'>
            ...
            <p>
              Quando o paciente aceita a vinculação com um profissional de psicologia, seus dados
              clínicos (humor, diário, tarefas, meditações) ficam acessíveis ao terapeuta para fins
              de acompanhamento terapêutico.
            </p>

            <h3 className='text-lg font-semibold'>5.2. Prestadores de Serviço</h3>
            <ul>
              <li>
                <strong>Turso (banco de dados)</strong>: Armazenamento seguro de dados
              </li>
              <li>
                <strong>Google Gemini API</strong>: Processamento de análises de pensamentos (dados
                anonimizados)
              </li>
              <li>
            ...
            <p>
              Todos os prestadores estão sujeitos a obrigações contratuais de confidencialidade e
              segurança.
            </p>

            <h3 className='text-lg font-semibold'>5.3. Autoridades Competentes</h3>
            <p>
              Dados poderão ser compartilhados com autoridades públicas quando exigido por lei ou
              ordem judicial.
            </p>
          </section>
          ...
          {/* Retenção */}
          <section className='mb-10'>
            <h2 className='text-xl font-bold'>6. Prazo de Retenção dos Dados</h2>
            ...
            <div className='overflow-x-auto'>
              <table className='w-full text-sm'>
                <thead>
                  <tr className='border-b border-slate-700'>
                    <th className='text-left py-3 px-4 text-white'>Tipo de Dado</th>
                    <th className='text-left py-3 px-4 text-white'>Prazo de Retenção</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className='border-b border-slate-800'>
                  ...
                  <tr className='border-b border-slate-800'>
                    <td className='py-3 px-4'>Registros clínicos (humor, diário, etc.)</td>
                    <td className='py-3 px-4'>Enquanto a conta estiver ativa + 20 anos (CFP)</td>
                  </tr>
                  <tr className='border-b border-slate-800'>
                    <td className='py-3 px-4'>Logs de acesso</td>
                    <td className='py-3 px-4'>6 meses (Marco Civil da Internet)</td>
                  </tr>
                  <tr className='border-b border-slate-800'>
                    <td className='py-3 px-4'>Dados anonimizados</td>
                    <td className='py-3 px-4'>Tempo indeterminado (não são dados pessoais)</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <section className='mb-10 rounded-2xl border border-violet-800/50 bg-violet-900/20 p-6'>
            ...
            <p>Conforme a LGPD (Lei nº 13.709/2018), você possui os seguintes direitos:</p>
            <ul>
              <li>
                <strong>Confirmação e Acesso</strong>: Confirmar a existência de tratamento e
                acessar seus dados
              </li>
              <li>
              ...
              <li>
                <strong>Portabilidade</strong>: Solicitar a portabilidade dos dados para outro
                serviço (exportação em formato estruturado)
              </li>
              <li>
                <strong>Eliminação</strong>: Solicitar a eliminação dos dados tratados com base no
                consentimento
              </li>
              <li>
              ...
              <li>
                <strong>Revogação do consentimento</strong>: Revogar o consentimento a qualquer
                momento
              </li>
            </ul>

            <div className='mt-4 rounded-xl bg-slate-800/50 p-4 not-prose'>
              <p className='text-white font-semibold mb-2'>Como exercer seus direitos:</p>
              <ul className='text-slate-300 text-sm space-y-1'>
                <li>
                  • <strong>No aplicativo</strong>: Acesse Perfil → Configurações → Meus Dados
                </li>
                <li>
          ...
          <section className='mb-10'>
            ...
            <ul>
              ...
              <li>Soft delete para recuperação de dados excluídos acidentalmente</li>
            </ul>
          </section>

          {/* Transferência Internacional */}
          <section className='mb-10'>
            <h2 className='text-xl font-bold'>9. Transferência Internacional de Dados</h2>
            <p>
              Alguns de nossos prestadores de serviço podem armazenar dados fora do Brasil. Nesses
              casos, garantimos que a transferência internacional ocorra apenas para países que
              proporcionem grau de proteção adequado ou mediante cláusulas contratuais padrão,
          ...
          {/* Cookies */}
          <section className='mb-10'>
            <h2 className='text-xl font-bold'>10. Cookies e Tecnologias Similares</h2>
            ...
            <p>Não utilizamos cookies para rastreamento publicitário ou perfilamento comercial.</p>
          </section>

          {/* Menores */}
          <section className='mb-10'>
            <h2 className='text-xl font-bold'>11. Dados de Crianças e Adolescentes</h2>
            <p>
              O Nepsis não é destinado a menores de 18 anos. Caso um menor utilize o aplicativo,
              isso deve ocorrer sob supervisão e responsabilidade de um responsável legal e de um
              profissional de psicologia habilitado.
            </p>
          </section>
          ...
          <section className='mb-10'>
            ...
            <p>
              Esta Política de Privacidade pode ser atualizada periodicamente. Em caso de alterações
              significativas, notificaremos os usuários por meio do aplicativo ou e-mail. A data da
          ...
          {/* Contato */}
          <section className='mb-10 rounded-2xl border border-slate-800 bg-slate-900/50 p-6'>
            <h2 className='text-xl font-bold text-white mt-0'>13. Contato e Encarregado (DPO)</h2>
            <p>
