...
export const ProfileView: React.FC<ProfileViewProps> = ({ onNavigate }) => {
  ...
  const [activeTab, setActiveTab] = useState<
    "rank" | "achievements" | "settings" | "mydata"
  >("achievements");
  const [showConsent, setShowConsent] = useState(false);
  const { data: termsData } =
    require("@/lib/trpc/client").trpc.user.checkTermsAccepted.useQuery();
  ...
  const selectedBadgeStatus = selectedBadge
        ...
        <div className="mt-6 flex flex-col items-center">
          <div className="relative mb-3">
            <svg className="h-[96px] w-[96px]" viewBox="0 0 100 100">
              ...
              <circle
                ...
                strokeDashoffset={
                  ringCircumference * (1 - levelProgressPercent / 100)
                }
          ...
          <div className="space-y-1 text-center">
            ...
            <div className="flex items-center justify-center gap-2">
              ...
              <span className="font-bold text-sm text-[#a1c797]">
                {currentRank.name}
              </span>
            </div>
          </div>
              ...
              {Object.entries(BADGE_CATEGORIES).map(([catKey, catInfo]) => {
                ...
                return (
                  <div className="space-y-3" key={catKey}>
                    <div
                      className={`flex items-center gap-2 font-bold text-sm ${catInfo.color}`}
                    >
          ...
          <div className="space-y-3 pb-8">
            ...
            >
              ...
              <div className="flex-shrink-0">
                {termsData?.termsAcceptedAt ? (
                  <span className="font-semibold text-[#a1c797] text-xs">
                    Assinado
                  </span>
                ) : (
                  <span className="font-semibold text-black/30 text-xs">
                    Não assinado
                  </span>
                )}
              </div>
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div className="text-left">
                  <h4 className="font-bold text-red-700 text-xs">
                    Excluir Minha Conta
                  </h4>
            ...
            <div className="p-6">
              <div className="mb-6 rounded-xl bg-amber-50 border border-amber-200 p-4">
                <p className="text-amber-800 text-sm">
                  ...
                  dados serão marcados para remoção. Conforme nossa política de
                  privacidade, seus dados serão anonimizados/excluídos em até 30
                  dias.
                </p>
              </div>
          ...
          <div className="w-full max-w-2xl overflow-hidden rounded-3xl bg-white shadow-2xl">
            ...
            <div className="max-h-[60vh] overflow-y-auto p-6 sm:p-8">
              <div className="prose prose-slate max-w-none prose-headings:text-black prose-p:text-black/80 prose-li:text-black/80 prose-strong:text-black">
                ...
                <p className="text-black/80">
                  Você pode deixar de utilizar a plataforma a qualquer momento,
                  sem prejuízo ao seu atendimento terapêutico presencial ou
                  online.
                </p>
              </div>
              <div className="mt-6 rounded-xl bg-[#a1c797]/10 p-4 text-black/60 text-sm">
                ...
                {termsData?.termsAcceptedAt ? (
                  <span className="font-mono">
                    {formatDateTime(termsData.termsAcceptedAt)}
                  </span>
                ) : (
              ...
              >
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-black/30 text-[10px]">
                    ...
                    {selectedBadge.metric !== "auto" && (
                      <>
                        ...
                        <div className="flex justify-between px-1 font-bold text-black/40 text-xs">
                          ...
                          <span>
                            {selectedBadgeStatus.currentProgress} /{" "}
