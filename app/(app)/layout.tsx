...
function AppLayoutContent({ children }: { children: ReactNode }) {
  ...
  const _hideHeader = pathname === '/rewards'
  ...
  return (
    <>
      ...
      <div className='flex h-[100dvh] min-h-[100dvh] overflow-hidden bg-black transition-colors duration-300 '>
        <div className='mx-auto flex h-full w-full relative max-w-md flex-col overflow-hidden bg-gradient-to-b from-[#fafafa] to-white'>
