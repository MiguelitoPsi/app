...
async function seed() {
  ...
  await db.insert(journalEntries).values([
    {
      ...
      userId: miguelId,
      content:
        'Primeiro dia de progresso. Hoje consegui completar todas as minhas tarefas. Me sinto motivado e ansioso para continuar essa jornada de autocuidado.',
      mood: 'happy',
      aiAnalysis:
    ...
    },
    {
      ...
      userId: miguelId,
      content:
        'Reflexão sobre ansiedade. Percebi que a meditação matinal tem me ajudado a lidar melhor com momentos de ansiedade durante o dia. Quero explorar mais técnicas de respiração.',
      mood: 'calm',
      aiAnalysis:
    ...
    },
    {
      ...
      userId: miguelId,
      content:
        'Gratidão pela jornada. Uma semana inteira mantendo a sequência! Me sinto mais equilibrado e focado. As pequenas conquistas estão fazendo diferença.',
      mood: 'happy',
      aiAnalysis:
    ...
    },
    {
      ...
      userId: juliaId,
      content:
        'Começando minha jornada. Primeira entrada no diário. Decidi que preciso cuidar melhor da minha saúde mental. Vou tentar ser consistente.',
      mood: 'calm',
  ...
  // ===== MOOD HISTORY =====
  const moods = ['happy', 'calm', 'anxious', 'sad', 'neutral', 'happy', 'angry'] as const
