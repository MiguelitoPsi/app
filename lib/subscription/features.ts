...
export const FEATURE_DEFINITIONS: FeatureDefinition[] = [
  {
    ...
    description: 'Acesso às análises de IA (análise de pensamentos, dados do paciente, etc).',
    type: 'boolean',
    default: false,
  },
  {
  ...
  },
  {
    ...
    description: 'Acesso ao módulo financeiro completo (receitas, despesas, metas).',
    type: 'boolean',
    default: false,
  },
  {
  ...
  },
  {
    ...
    description: 'Quantidade máxima de uploads de arquivos por mês. 0 = ilimitado.',
    type: 'number',
    default: 10,
  },
  {
