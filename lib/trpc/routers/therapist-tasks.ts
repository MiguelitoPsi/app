  ...
  create: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      const effectivePriority =
        input.taskCategory === "sessao" ? "high" : input.priority;
      ...
      const generateRecurringDates = (
        ...
        while (true) {
          ...
          if (
            nextDate.getMonth() !== targetMonth ||
            nextDate.getFullYear() !== targetYear
          ) {
            break;
          }
