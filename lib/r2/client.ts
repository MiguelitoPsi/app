...
const hasR2Credentials = CLOUDFLARE_ACCOUNT_ID && R2_ACCESS_KEY_ID && R2_SECRET_ACCESS_KEY
if (!hasR2Credentials) {
  console.warn('R2 credentials not configured. Upload functionality will not work.')
}
